	...
	<div id="page">
		...
		<div id="content">
			...
			if (isset($_POST["aanmelden"])) {
				...
				$query1 = "UPDATE evenement SET categorieid='$categorie', naam='$naam', omschrijving='$tekstvak', begindatum='$bdatum', einddatum='$edatum', isaanmeldingverplicht='$aanmelden', organiserendeverenigingid='$vereniging' 
