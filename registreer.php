<?php
	...
	*/
	...
	class registreer(){
		public function maakRij($gegevens){
			/*Deze functie bevat de queries die nodig zijn om een nieuw record te maken in de tabel
			Gebruikers. Ook worden ze uitgevoerd.*/
